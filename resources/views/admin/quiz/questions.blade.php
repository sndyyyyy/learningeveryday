        ...
        <div class="md:col-span-1 flex flex-col space-y-6">
            ...
            <div class="bg-white p-5 md:p-6 rounded-xl shadow-sm h-fit border border-gray-100">
                ...
                <form action="{{ route('admin.quiz.questions.store', $quiz->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div>
                        <label class="block text-gray-600 text-xs font-semibold mb-1">Gambar Soal (Optional)</label>
                        <div class="flex gap-1.5 items-center mb-1.5">
                            <input type="text" name="selected_image_path" id="in-image-path" readonly placeholder="Atau pilih dari galeri..." class="flex-1 px-3 py-1.5 border border-gray-200 rounded-lg text-xs bg-gray-50 text-gray-600 focus:outline-none">
    ...
    <div id="edit-modal" class="fixed inset-0 bg-black/50 hidden justify-center items-center z-50 backdrop-blur-xs">
        <div class="bg-white p-6 rounded-2xl max-w-lg w-[90%] shadow-2xl overflow-y-auto max-h-[90vh]">
            ...
            <form id="edit-form" method="POST" enctype="multipart/form-data" class="space-y-4 text-left">
                ...
                <!-- GANTI GAMBAR UTAMA DI EDIT MODAL -->
                <div class="border border-gray-100 p-3 rounded-xl bg-gray-50/50">
                    ...
                    <div class="flex gap-1.5 items-center mb-1.5">
                        <input type="text" name="selected_image_path" id="edit-image-path" readonly placeholder="Atau pilih dari galeri..." class="flex-1 px-3 py-1.5 border border-gray-200 rounded-lg text-xs bg-white text-gray-600 focus:outline-none">
                ...
                <!-- GANTI AUDIO UTAMA DI EDIT MODAL -->
                <div class="border border-gray-100 p-3 rounded-xl bg-gray-50/50">
                    <label class="block text-gray-600 text-xs font-semibold mb-1">Ganti Audio Listening (Optional)</label>
                    <div class="flex gap-1.5 items-center mb-1.5">
                        <input type="text" name="selected_audio_path" id="edit-audio-path" readonly placeholder="Atau pilih dari galeri..." class="flex-1 px-3 py-1.5 border border-gray-200 rounded-lg text-xs bg-white text-gray-600 focus:outline-none">
                        <button type="button" onclick="openMediaPickerModal('edit-audio-path')" class="bg-amber-50 hover:bg-amber-100 text-amber-700 font-bold px-3 py-1.5 rounded-lg text-xs border border-amber-200 transition cursor-pointer whitespace-nowrap">
                            📁 Galeri
                        </button>
                    </div>
                ...
                <!-- GANTI OPSI A, B, C, D PADA MODAL EDIT MODAL DENGAN DUKUNGAN GAMBAR -->

                    ...
                    <div id="container-multiple-choice" class="space-y-4">
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <input type="text" name="option_a" class="w-full px-3 py-1.5 border border-gray-200 rounded-lg text-xs focus:outline-none">
                            </div>
                            <div>
                                <label class="block text-gray-600 text-xs font-semibold mb-1">Pilihan B</label>
                                <input type="text" name="option_b" class="w-full px-3 py-1.5 border border-gray-200 rounded-lg text-xs focus:outline-none">
                            </div>
                            <div>
                                <label class="block text-gray-600 text-xs font-semibold mb-1">Pilihan C</label>
                                <input type="text" name="option_c" class="w-full px-3 py-1.5 border border-gray-200 rounded-lg text-xs focus:outline-none">
                            </div>
                            <div>
                                <label class="block text-gray-600 text-xs font-semibold mb-1">Pilihan D</label>
                                <input type="text" name="option_d" class="w-full px-3 py-1.5 border border-gray-200 rounded-lg text-xs focus:outline-none">
                            </div>
                        </div>
                        <div>
                    ...
                    <div class="border-b border-gray-100 pb-6 relative group">
                        <div class="flex justify-between items-start mb-2">
                            ...
                            <div class="flex space-x-2 shrink-0">
                                ...
                                <button type="button"
                                        ...
                                        class="text-indigo-600 hover:text-indigo-800 bg-indigo-50 px-2 py-1 rounded text-xs font-bold transition cursor-pointer">
                                    Edit
                                </button>
                        ...
                        @if($q->audio)
                            <div class="my-3 pl-4 max-w-sm">
                                <audio src="{{ route('audio.stream', ['path' => $q->audio]) }}" controls class="w-full max-w-sm outline-none scale-90 origin-left"></audio>
                            </div>
                        @endif
